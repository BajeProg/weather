...
|Таблица|Описание|
|:----:|:----|
|Weather|Таблица с данными о погоде. Заполняется автоматически каждый час благодоря **крон операции**|
...
## Экспорт данных 
Для экспорта данных за текущий час нажмите кнопку "Экспорт" на [главной странице](https://otakuclique.ru) или воспользуйтесь [прямой ссылкой](https://otakuclique.ru/download.php)
